...
fn main() {
    ...
    let parameters = Parameters {delta_time: 0.003, updates_per_frame: 10000, angular_velocity: false, camera_pos: Vec4{ x: 0.0, y: 0.0, z: 0.0, w: -5.0}, gravity: false, world_size: 300.0 };
