...
fn main() {
    ...
    let parameters = Parameters {delta_time: 1.0 / 1000.0, updates_per_frame: 10, angular_velocity: true, camera_pos: Vec4{ x: 0.0, y: 0.0, z: 0.0, w: -10.0}, gravity: true, world_size: 300.0 };
